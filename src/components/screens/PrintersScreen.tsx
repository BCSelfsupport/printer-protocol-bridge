...
export function PrintersScreen({
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-3 md:p-4 gap-3 md:gap-4 overflow-hidden">
      ...
      <div className={`${showDashboardInPanel ? 'w-full md:w-80 lg:w-96' : 'w-full md:w-96'} flex-shrink-0 flex flex-col bg-slate-900/50 rounded-xl border border-slate-800 overflow-hidden`}>
        {/* Header */}
