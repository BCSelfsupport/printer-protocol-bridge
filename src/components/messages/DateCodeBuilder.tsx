    ...
    <Dialog open={open} onOpenChange={handleOpen}>
      <DialogContent className="sm:max-w-xl p-0 overflow-hidden max-h-[90vh]">
        <div className="flex flex-col max-h-[90vh]">
          {/* Header — fixed */}
          <div className="shrink-0 bg-gradient-to-b from-muted to-muted/80 px-4 py-3 flex items-center gap-3 border-b">
          ...
          <div className="shrink-0 border-t bg-background px-4 py-3">
            <button
              ...
              className="w-full industrial-button px-6 py-2.5 rounded font-medium text-sm disabled:opacity-40 disabled:cursor-not-allowed bg-primary text-primary-foreground hover:bg-primary/90"
            >
              Add to Message
            </button>
          </div>
